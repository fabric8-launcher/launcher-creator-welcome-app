          ...
          <div className="input-group input-group-lg">
            ...
            <div className="input-group input-group-lg">
              ...
              <p className="help-block">
                The source for this {this.props.type===MessagingDestinationType.QUEUE ? "consumer" : "subscriber"} may be found in your codebase
                at <samp><a href={this.props.receiverSourceUrl} className="text-monospace" target="_blank" data-toggle="tooltip"
