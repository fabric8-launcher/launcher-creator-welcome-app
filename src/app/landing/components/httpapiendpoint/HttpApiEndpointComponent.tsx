...
interface HttpApiEndpointState {
...
class HttpApiEndpointComponent extends React.Component<IHttpApiEndpoint, HttpApiEndpointState> {
          ...
          <LocalForm
            ...
            <div className="col-sm-9">
              ...
              <Control.textarea 
                ...
                rows={5}
                disabled={true}
                value={this.state.consoleContent}
                />
